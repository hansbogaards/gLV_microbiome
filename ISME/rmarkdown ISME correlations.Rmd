...
## Solve the model
The gLV model was solved with the lsoda function (from the deSolve package version 1.24). Because, most gut microbiota studies are limited to only a few samples in time, presenting mere ‘snapshots’ of the intestinal ecosystem, in the base case study, only  one sample was 'taken' of the species abundances in the equilibrium. 
...
for ( i in 1:length( results.pcor ) ) {
  ...
  # Change the matrices to negative (-1), no (0) and positive interaction (-1) matrices
